...
function _init() {
  ...
  window.setTimeout(() => {
    ...
    _node1.textOption = textFile.textContent.split(',').filter(function (el) {
      return el.length != 0;
    });
    ...
    _node2.textOption = textFile.textContent.split(',').filter(function (el) {
      return el.length != 0;
    });
    ...
    _node3.textOption = textFile.textContent.split(',').filter(function (el) {
      return el.length != 0;
    });
